...
#define CONF_GPIO_PIN   GPIO_NUM_2
#define LED_GPIO_PIN   GPIO_NUM_26
...
void setup()
{
  ...
  if (isSetupModeEnabled()) { // configuration
    ...
    Serial.println("DEBUG: OV2640 Camera  connected");
